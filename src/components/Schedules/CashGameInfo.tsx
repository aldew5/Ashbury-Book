...
import getCashGameData from "../../utils/getCashGameData";
...
const CashGameInfo = ({
    ...
    // independent states because we only need to show 
    // game data retreived from mongo
    ...
    const checkIfJoined = async () => {
        const request = await fetch(
            `${process.env.REACT_APP_API_URL}/amijoinedCash/${gameTitle}`,
            {
                method: "GET",
                headers: {
    ...
    const init = async () => {
        ...
        const gameData = await getCashGameData(gameTitle);

        setGameTime(gameData.time);
        setMin(gameData.minBuyin);
        setMax(gameData.maxBuyin);
